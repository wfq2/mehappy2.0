...
exports.loadSchema = function (schemaDef, config) { return __awaiter(_this, void 0, void 0, function () {
    var pointToSchema, defObject, loaderString, customSchemaLoader, returnedSchema, e_1, pointToSchema, options;
...
exports.loadDocuments = function (documentDef, config) { return __awaiter(_this, void 0, void 0, function () {
    var pointToDoc, defObject, loaderString, customDocumentLoader, returned, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 6: return [2 /*return*/, graphql_toolkit_1.loadDocuments(documentDef, config.pluckConfig
                    ? {
