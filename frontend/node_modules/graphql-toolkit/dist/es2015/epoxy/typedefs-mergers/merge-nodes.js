...
export function mergeGraphQLNodes(nodes) {
    return nodes.reduce((prev, nodeDefinition) => {
        ...
        if (node && node.name && node.name.value) {
            ...
            if (isGraphQLType(nodeDefinition) || isGraphQLTypeExtension(nodeDefinition)) {
                ...
                prev[name] = mergeInputType(nodeDefinition, prev[name]);
            }
            else if (isGraphQLInterface(nodeDefinition) || isGraphQLInterfaceExtension(nodeDefinition)) {
                prev[name] = mergeInterface(nodeDefinition, prev[name]);
            }
